...
<%--
1) jsp:useBean
=> JSP에서 특별히 제공하는 태그이기 때문에 "jsp" 네임스페이스를 따로 임포트 할 필요는 없다.
...
scope : 객체를 찾거나 생성한 객체를 저장할 보관소를 지정한다.
        page        => PageContext (기본값)
...
자바코드: List<String> list2 = new java.util.ArrayList();
--%>

<%--예제1) ArrayList 객체 생성하rh PageContext에 보관하기 --%>
<jsp:useBean id="list" class="java.util.ArrayList"/>
<%--자바 코드
ArrayList list = (ArrayList)pageContext.getAttribute("list");
if (list == null) {
  list = new ArrayList();
  pageContext.setattrivetr("list", list);
--%>
