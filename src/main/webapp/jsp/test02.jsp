...
--%>
<!-- 이거 그냥 텍스트이다. 주석아니다. 물론 웹 브라우저에서는 주석으로 간주하겠지만,
...
<%--
3) 스크립트릿(scriptlet)
   - 그대로 자바 파일의 _jspService() 메서드 안에 그대로 복사된다.
   - 현재는 자바 언어만 지원한다.
   - 자바의 일부 코드 조각이라는 의미에서 script + let(작은) = scriptlet이라 부른다.
--%>
