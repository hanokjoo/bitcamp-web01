...
//      System.out.println("m2 돌아온다"); // servlet29_2가 실행을 끝내고 돌아온다면 출력될것이다.
//      out.println("m2 포워딩 후 출력");
      return;
    
    } else if("m3".equals(menuNo)) {
      RequestDispatcher rd = request.getRequestDispatcher("/servlet/servlet29_3");
      rd.forward(request, response);
//      System.out.println("m3 돌아온다"); // servlet29_3가 실행을 끝내고 돌아온다면 출력될것이다.
//      out.println("m3 포워딩 후 출력");
      return;
    }
  }
}
